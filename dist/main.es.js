...
function useLoadingScreen(isLoading2) {
  const uuid = react.exports.useRef("");
  const loadingEntities2 = react.exports.useSyncExternalStore(loadingEntitiesStore.subscribe, loadingEntitiesStore.getSnapshot);
  ...
  return {
    startLoading: react.exports.useCallback(() => {
      loadingEntitiesStore.loadingStarted(uuid.current);
    }, []),
    stopLoading: react.exports.useCallback(() => {
      loadingEntitiesStore.loadingStopped(uuid.current);
    }, [])
  };
}
...
var formatMuiErrorMessage = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
...
reactIs_production_min$1.isValidElementType = function(a) {
  return "string" === typeof a || "function" === typeof a || a === e$1 || a === m$2 || a === g$1 || a === f$2 || a === p$3 || a === q$2 || "object" === typeof a && null !== a && (a.$$typeof === t$1 || a.$$typeof === r$1 || a.$$typeof === h$1 || a.$$typeof === k$2 || a.$$typeof === n$2 || a.$$typeof === w || a.$$typeof === x || a.$$typeof === y || a.$$typeof === v$2);
};
 ...
 * LICENSE file in the root directory of this source tree.
 */
var f$1 = react.exports, k$1 = Symbol.for("react.element"), l$1 = Symbol.for("react.fragment"), m$1 = Object.prototype.hasOwnProperty, n$1 = f$1.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, p$2 = { key: true, ref: true, __self: true, __source: true };
...
function StyledEngineProvider(props) {
  ...
  return injectFirst && cache ? /* @__PURE__ */ jsxRuntime.exports.jsx(CacheProvider, {
    value: cache,
    children
  }) : children;
}
...
function deepmerge$1(target, source, options = {
  ...
  if (isPlainObject(target) && isPlainObject(source)) {
    Object.keys(source).forEach((key) => {
      if (isPlainObject(source[key]) && Object.prototype.hasOwnProperty.call(target, key) && isPlainObject(target[key])) {
...
var deepmerge = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  "default": deepmerge$1,
  isPlainObject
}, Symbol.toStringTag, { value: "Module" }));
...
var capitalize = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
...
var createTheme$1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
...
function useTheme$2(defaultTheme2 = null) {
  const contextTheme = react.exports.useContext(ThemeContext);
...
var styleFunctionSx = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
 ...
 * LICENSE file in the root directory of this source tree.
 */
var b = Symbol.for("react.element"), c = Symbol.for("react.portal"), d = Symbol.for("react.fragment"), e = Symbol.for("react.strict_mode"), f = Symbol.for("react.profiler"), g = Symbol.for("react.provider"), h = Symbol.for("react.context"), k = Symbol.for("react.server_context"), l = Symbol.for("react.forward_ref"), m = Symbol.for("react.suspense"), n = Symbol.for("react.suspense_list"), p$1 = Symbol.for("react.memo"), q = Symbol.for("react.lazy"), t = Symbol.for("react.offscreen"), u;
...
reactIs_production_min.isValidElementType = function(a) {
  return "string" === typeof a || "function" === typeof a || a === d || a === f || a === e || a === m || a === n || a === t || "object" === typeof a && null !== a && (a.$$typeof === q || a.$$typeof === p$1 || a.$$typeof === g || a.$$typeof === h || a.$$typeof === l || a.$$typeof === u || void 0 !== a.getModuleId) ? true : false;
};
...
var getDisplayName = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
...
var clamp = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  "default": clamp$1
}, Symbol.toStringTag, { value: "Module" }));
...
function isMuiElement(element, muiNames) {
  ...
  return /* @__PURE__ */ react.exports.isValidElement(element) && muiNames.indexOf(
...
function useEventCallback(fn) {
  ...
  return react.exports.useRef((...args) => (0, ref.current)(...args)).current;
}
...
function useLazyRef(init, initArg) {
  const ref = react.exports.useRef(UNINITIALIZED);
...
function useOnMount(fn) {
  react.exports.useEffect(fn, EMPTY);
}
class Timeout {
  constructor() {
    this.currentId = null;
...
function useSlotProps(parameters) {
  ...
  } = parameters, rest = _objectWithoutPropertiesLoose(parameters, _excluded$t);
...
const RtlContext = /* @__PURE__ */ react.exports.createContext();
const useRtl = () => {
  const value = react.exports.useContext(RtlContext);
  return value != null ? value : false;
};
const PropsContext = /* @__PURE__ */ react.exports.createContext(void 0);
...
function useDefaultProps$1({
  ...
  const ctx = react.exports.useContext(PropsContext);
...
var _extends2 = _interopRequireDefault(_extends.exports);
...
const SvgIcon = /* @__PURE__ */ react.exports.forwardRef(function SvgIcon2(inProps, ref) {
  ...
  const hasSvgAsChild = /* @__PURE__ */ react.exports.isValidElement(children) && children.type === "svg";
...
const TextareaAutosize = /* @__PURE__ */ react.exports.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  ...
  const heightRef = react.exports.useRef(null);
  const shadowRef = react.exports.useRef(null);
  const calculateTextareaStyles = react.exports.useCallback(() => {
  ...
  return /* @__PURE__ */ jsxRuntime.exports.jsxs(react.exports.Fragment, {
    children: [!disableInjectingGlobalStyles && inputGlobalStyles, /* @__PURE__ */ jsxRuntime.exports.jsxs(Root, _extends$1({}, rootProps, !isHostComponent(Root) && {
      ...
      children: [startAdornment, /* @__PURE__ */ jsxRuntime.exports.jsx(FormControlContext$1.Provider, {
        value: null,
        children: /* @__PURE__ */ jsxRuntime.exports.jsx(Input3, _extends$1({
          ownerState,
...
const Backdrop = /* @__PURE__ */ react.exports.forwardRef(function Backdrop2(inProps, ref) {
  ...
  return /* @__PURE__ */ jsxRuntime.exports.jsx(TransitionComponent, _extends$1({
    ...
    children: /* @__PURE__ */ jsxRuntime.exports.jsx(BackdropRoot, _extends$1({
      "aria-hidden": true
    }, rootSlotProps, {
...
const Modal = /* @__PURE__ */ react.exports.forwardRef(function Modal2(inProps, ref) {
  ...
  return /* @__PURE__ */ jsxRuntime.exports.jsx(Portal$1, {
    ...
    container,
    disablePortal,
    children: /* @__PURE__ */ jsxRuntime.exports.jsxs(RootSlot, _extends$1({}, rootProps, {
      children: [!hideBackdrop && BackdropComponent ? /* @__PURE__ */ jsxRuntime.exports.jsx(BackdropSlot, _extends$1({}, backdropProps)) : null, /* @__PURE__ */ jsxRuntime.exports.jsx(FocusTrap, {
        disableEnforceFocus,
        disableAutoFocus,
        disableRestoreFocus,
...
const FilledInput = /* @__PURE__ */ react.exports.forwardRef(function FilledInput2(inProps, ref) {
  ...
  return /* @__PURE__ */ jsxRuntime.exports.jsx(InputBase$1, _extends$1({
    slots: {
      root: RootSlot,
      input: InputSlot
    },
...
const FormControl = /* @__PURE__ */ react.exports.forwardRef(function FormControl2(inProps, ref) {
  ...
  return /* @__PURE__ */ jsxRuntime.exports.jsx(FormControlContext$1.Provider, {
    value: childContext,
    children: /* @__PURE__ */ jsxRuntime.exports.jsx(FormControlRoot, _extends$1({
      as: component,
      ownerState,
      className: clsx(classes.root, className),
      ref
...
const FormHelperText = /* @__PURE__ */ react.exports.forwardRef(function FormHelperText2(inProps, ref) {
  ...
  return /* @__PURE__ */ jsxRuntime.exports.jsx(FormHelperTextRoot, _extends$1({
    as: component,
    ownerState,
    className: clsx(classes.root, className),
    ref
  }, other, {
    children: children === " " ? _span$2 || (_span$2 = /* @__PURE__ */ jsxRuntime.exports.jsx("span", {
...
const FormLabel = /* @__PURE__ */ react.exports.forwardRef(function FormLabel2(inProps, ref) {
  ...
  return /* @__PURE__ */ jsxRuntime.exports.jsxs(FormLabelRoot, _extends$1({
    as: component,
    ownerState,
    className: clsx(classes.root, className),
    ref
...
const InputLabel = /* @__PURE__ */ react.exports.forwardRef(function InputLabel2(inProps, ref) {
  ...
  return /* @__PURE__ */ jsxRuntime.exports.jsx(InputLabelRoot, _extends$1({
    "data-shrink": shrink,
    ownerState,
    ref,
    className: clsx(classes.root, className)
...
const Popover = /* @__PURE__ */ react.exports.forwardRef(function Popover2(inProps, ref) {
  ...
  return /* @__PURE__ */ jsxRuntime.exports.jsx(RootSlot, _extends$1({}, rootProps, !isHostComponent(RootSlot) && {
    slotProps: rootSlotPropsProp,
    disableScrollLock
  }, {
    children: /* @__PURE__ */ jsxRuntime.exports.jsx(TransitionComponent, _extends$1({
      ...
      children: /* @__PURE__ */ jsxRuntime.exports.jsx(PaperSlot, _extends$1({}, paperProps, {
        children
      }))
    }))
  }));
...
const NativeSelectInput = /* @__PURE__ */ react.exports.forwardRef(function NativeSelectInput2(props, ref) {
  ...
  return /* @__PURE__ */ jsxRuntime.exports.jsxs(react.exports.Fragment, {
    children: [/* @__PURE__ */ jsxRuntime.exports.jsx(NativeSelectSelect, _extends$1({
      ownerState,
...
function NotchedOutline(props) {
  ...
  return /* @__PURE__ */ jsxRuntime.exports.jsx(NotchedOutlineRoot$1, _extends$1({
    "aria-hidden": true,
    className,
    ownerState
  }, other, {
...
const SelectInput = /* @__PURE__ */ react.exports.forwardRef(function SelectInput2(props, ref) {
  ...
  return /* @__PURE__ */ jsxRuntime.exports.jsxs(react.exports.Fragment, {
    children: [/* @__PURE__ */ jsxRuntime.exports.jsx(SelectSelect, _extends$1({
      ...
      id: buttonId,
      children: isEmpty(display) ? _span || (_span = /* @__PURE__ */ jsxRuntime.exports.jsx("span", {
        className: "notranslate",
        children: "\u200B"
      })) : display
    })), /* @__PURE__ */ jsxRuntime.exports.jsx(SelectNativeInput, _extends$1({
      "aria-invalid": error,
      ...
      className: classes.icon,
      ownerState
    }), /* @__PURE__ */ jsxRuntime.exports.jsx(Menu$1, _extends$1({
      id: `menu-${name || ""}`,
...
const TextField = /* @__PURE__ */ react.exports.forwardRef(function TextField2(inProps, ref) {
  ...
  const InputElement = /* @__PURE__ */ jsxRuntime.exports.jsx(InputComponent, _extends$1({
  ...
  return /* @__PURE__ */ jsxRuntime.exports.jsxs(TextFieldRoot, _extends$1({
    className: clsx(classes.root, className),
    disabled,
    error,
    fullWidth,
    ...
    children: [label != null && label !== "" && /* @__PURE__ */ jsxRuntime.exports.jsx(InputLabel$1, _extends$1({
      htmlFor: id2,
      id: inputLabelId
    }, InputLabelProps, {
      children: label
    })), select ? /* @__PURE__ */ jsxRuntime.exports.jsx(Select$1, _extends$1({
      "aria-describedby": helperTextId,
      id: id2,
      ...
      children
    })) : InputElement, helperText && /* @__PURE__ */ jsxRuntime.exports.jsx(FormHelperText$1, _extends$1({
      id: helperTextId
    }, FormHelperTextProps, {
      children: helperText
    }))]
